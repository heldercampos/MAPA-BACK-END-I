...
if($tablename == '$donuts'){
    ...
    $nome = $donuts[$id]['nome'];   
    $preco = $donuts[$id]['preco'];   
    $img = $donuts[$id]['imgPath'];   
    $descricao = $donuts[$id]['descricao'];   
}else if($tablename == '$recheados'){
    $nome = $recheados[$id]['nome'];   
    $preco = $recheados[$id]['preco'];   
    $img = $recheados[$id]['imgPath'];  
    $descricao = $recheados[$id]['descricao'];   
}else if($tablename == '$especiais'){
    $nome = $especiais[$id]['nome'];   
    $preco = $especiais[$id]['preco'];   
    $img = $especiais[$id]['imgPath'];  
    $descricao = $especiais[$id]['descricao'];   
}
